...
import { projects, socialLinks } from "@/lib/personal";
        ...
        <section className="py-20 px-4 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 text-center max-w-2xl mx-auto mb-12">
              A collection of web applications, tools, and projects I&apos;ve
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
              ...
              <select
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
              >
              ...
              {projects
                ...
                .map((project) => (
                  <button
                    ...
                    className="px-4 py-2 rounded-full text-sm font-medium bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 hover:bg-yellow-200 dark:hover:bg-yellow-800 transition-colors"
                  >
                    Featured
                  </button>
                ))}
